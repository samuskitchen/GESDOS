...
public class TrabaLogic implements ITrabaLogic {
    ...
    public void saveTraba(Traba entity) throws Exception {
        try {
            ...
            if ((entity.getTraApe1() != null) &&
                ...
                throw new ZMessManager().new NotValidFormatException("Primer Apellido");
            }
            ...
            if ((entity.getTraApe2() != null) &&
                ...
                throw new ZMessManager().new NotValidFormatException("Segundo Apellido");
            }

            if (entity.getTraCed() == null) {
                throw new ZMessManager().new EmptyFieldException("Cedula Trabajador");
            }

            if ((entity.getTraCed() != null) &&
                    (Utilities.checkNumberAndCheckWithPrecisionAndScale("" +
                        entity.getTraCed(), 22, 0) == false)) {
                throw new ZMessManager().new NotValidFormatException("Cedula Trabajador");
            }

            if (entity.getTraEst() == null) {
                throw new ZMessManager().new EmptyFieldException("Estado Trabaajador");
            }

            if ((entity.getTraEst() != null) &&
                    (Utilities.checkWordAndCheckWithlength(entity.getTraEst(), 1) == false)) {
                throw new ZMessManager().new NotValidFormatException("Estado Trabaajador");
            }

            if (entity.getTraFecIni() == null) {
                throw new ZMessManager().new EmptyFieldException("Fecha Registro en RDC");
            }
            ...
            if ((entity.getTraNom() != null) &&
                    (Utilities.checkWordAndCheckWithlength(entity.getTraNom(),
                        20) == false)) {
                throw new ZMessManager().new NotValidFormatException("Nombre");
            }

            if ((entity.getTraObs() != null) &&
                    (Utilities.checkWordAndCheckWithlength(entity.getTraObs(),
                        100) == false)) {
                throw new ZMessManager().new NotValidFormatException("Observación");
            }
            ...
            if ((entity.getTraSex() != null) &&
                    (Utilities.checkWordAndCheckWithlength(entity.getTraSex(), 1) == false)) {
    ...
    public List<TrabaDTO> getDataTraba() throws Exception {
        try {
            List<Traba> traba = trabaDAO.findAll();

            List<TrabaDTO> trabaDTO = new ArrayList<TrabaDTO>();

            for (Traba trabaTmp : traba) {
                TrabaDTO trabaDTO2 = new TrabaDTO();

                trabaDTO2.setTraCed(trabaTmp.getTraCed());
                trabaDTO2.setTraApe1((trabaTmp.getTraApe1() != null)
                    ? trabaTmp.getTraApe1() : null);
                trabaDTO2.setTraApe2((trabaTmp.getTraApe2() != null)
                    ? trabaTmp.getTraApe2() : null);
                trabaDTO2.setTraEst((trabaTmp.getTraEst() != null)
                    ? trabaTmp.getTraEst() : null);
                trabaDTO2.setTraFecIni(trabaTmp.getTraFecIni());
                trabaDTO2.setTraNom((trabaTmp.getTraNom() != null)
                    ? trabaTmp.getTraNom() : null);
                trabaDTO2.setTraObs((trabaTmp.getTraObs() != null)
                    ? trabaTmp.getTraObs() : null);
                trabaDTO2.setTraSex((trabaTmp.getTraSex() != null)
                    ? trabaTmp.getTraSex() : null);

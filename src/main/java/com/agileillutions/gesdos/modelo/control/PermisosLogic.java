...
import com.agileillutions.gesdos.dataaccess.dao.IPermisosDAO;
...
*/
@Scope("singleton")
@Service("PermisosLogic")
public class PermisosLogic implements IPermisosLogic {
    /**
    ...
    public void savePermisos(Permisos entity) throws Exception {
        try {
            ...
            if (getPermisos(entity.getId()) != null) {
                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
            }

            permisosDAO.save(entity);
        } catch (Exception e) {
            throw e;
        } finally {
        }
    ...
    public void deletePermisos(Permisos entity) throws Exception {
        if (entity == null) {
            throw new ZMessManager().new NullEntityExcepcion("Permisos");
        }
    ...
    public List<PermisosDTO> getDataPermisos() throws Exception {
        try {
            ...
            List<PermisosDTO> permisosDTO = new ArrayList<PermisosDTO>();

            for (Permisos permisosTmp : permisos) {
                PermisosDTO permisosDTO2 = new PermisosDTO();

                permisosDTO2.setGrupCodigo(permisosTmp.getId().getGrupCodigo());
                permisosDTO2.setProgCodigo(permisosTmp.getId().getProgCodigo());
                permisosDTO2.setEvenCodigo(permisosTmp.getId().getEvenCodigo());
                permisosDTO.add(permisosDTO2);
            }
    ...
    public Permisos getPermisos(PermisosId id) throws Exception {
        ...
        try {
            entity = permisosDAO.findById(id);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Permisos");
        } finally {
        }
    ...
    public List<Permisos> findPagePermisos(String sortColumnName,
        ...
        throws Exception {
        List<Permisos> entity = null;

        try {
            entity = permisosDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Permisos Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Permisos> findByCriteria(Object[] variables,
        ...
        try {
            list = permisosDAO.findByCriteria(where);
        } catch (Exception e) {
